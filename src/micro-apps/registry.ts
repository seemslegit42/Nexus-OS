...
> = {
  ...
  // 'performance-monitor-v1': () => import('./PerformanceMonitor'), // Performance monitoring micro-app - temporarily disabled (file missing)
...
export function getDynamicImportFn(
  appId: string
