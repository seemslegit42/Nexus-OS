  ...
  return (
    <div className="flex flex-col gap-6 p-4 md:p-6">
      ...
      <Card>
        ...
        <CardFooter>
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground"><UserPlus className="mr-2 h-4 w-4" /> Send Invitation</Button>
        </CardFooter>
      </Card>

      <Card>
        <CardHeader>
          <CardTitle className="font-headline">Current Team Members ({teamMembers.length})</CardTitle>
        ...
        <CardContent>
          <Table>
           ...
           {teamMembers.length === 0 && <p className="text-sm text-center py-4 text-muted-foreground">No team members yet. Invite someone to collaborate!</p>}
        </CardContent>
      </Card>
    </div>
  );
