...
export default function AccountProfilePage() {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col gap-6 p-4 md:p-6 max-w-3xl mx-auto items-center justify-center h-full">
        ...
        <Card>
          ...
          <CardContent className="grid gap-6">
            <div className="flex items-center gap-4">
              ...
              <Button variant="outline" type="button"><Camera className="mr-2 h-4 w-4" /> Change Avatar</Button>
            </div>
          ...
          <CardFooter>
            <Button type="submit" className="ml-auto bg-primary hover:bg-primary/90 text-primary-foreground"><Save className="mr-2 h-4 w-4" /> Save Changes</Button>
          </CardFooter>
        </Card>
      </form>
