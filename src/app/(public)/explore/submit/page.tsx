...
import { ArrowLeft, CloudArrowUp as UploadCloud } from '@phosphor-icons/react';
    ...
    <div className="mx-auto max-w-3xl p-4 md:p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Share your item, module, or template with the NexOS community.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          <div className="grid gap-2">
            ...
            <Input
              id="creationName"
              placeholder="e.g., Awesome AI Assistant Module"
            />
          </div>
          <div className="grid gap-2">
            ...
            <Select>
              ...
              <SelectContent>
                <SelectItem value="item">
                  Item (Pre-built Application/Service)
                </SelectItem>
                <SelectItem value="module">
                  Module (Reusable Component/Function)
                </SelectItem>
                <SelectItem value="template">
                  Template (Starter Project/Configuration)
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="grid gap-2">
            ...
            <Textarea
              id="description"
              placeholder="Describe your creation, its features, and how to use it."
