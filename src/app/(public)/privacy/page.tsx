        ...
        <Card>
          ...
          <CardContent>
            <div className="prose prose-sm prose-invert max-w-none sm:prose-base lg:prose-lg prose-headings:font-headline prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-primary hover:prose-a:underline">
              <p>
                Welcome to NexOS Platform&apos;s Privacy Policy. This policy
              ...
              <p>
                ...
                when you create an account, as well as information automatically
                collected when you use our services (e.g., IP address, browser
                type).
              </p>
              ...
              <p>
                ...
                services, to communicate with you, and for security purposes.
              </p>
              ...
              <p>
                ...
                operating our platform, under strict confidentiality agreements.
              </p>
              ...
              <p>
                You can access and update your account information. You may also
                have rights regarding your data under applicable laws.
              </p>
              ...
              <p>
                ...
                contact us at privacy@nexosplatform.example.com.
              </p>
            </div>
          </CardContent>
        </Card>
