...
function OnboardingWizardContent({ currentStep, nextStep, prevStep }: { currentStep: number, nextStep: () => void, prevStep: () => void }): ReactNode {
  ...
  return (
    <Card className="h-full bg-transparent border-none shadow-none flex items-center justify-center"> {/* This outer card centers content */}
      <Card className="max-w-2xl w-full"> {/* Inner card gets the glassmorphic style */}
