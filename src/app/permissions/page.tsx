...
function SimulateBreachEscalationContent(): ReactNode { 
  return (
    <Card className="h-full flex flex-col bg-transparent border-none shadow-none">
      ...
      <CardContent className="p-2 md:p-3 space-y-3 flex-grow">
        <Image src="https://placehold.co/600x300.png" alt="Breach Simulation Control Panel" width={600} height={300} className="rounded-md border border-border/60 opacity-70" data-ai-hint="security test scenario controls parameters" />
      </CardContent>
